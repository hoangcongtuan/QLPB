		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="xem_nhan_vien.php">Tìm kiếm nhân viên</a>
                </div>
                                    ...
                                    <tbody class="danhsach">
                                        <?php
                                            if (isset($_POST['keyword'])) {
                                                ...
                                                // ORDER BY IDNV ";
                                                $qr_search="SELECT IDNV, Hoten, phongban.TenPB, Diachi 
                                                FROM phongban INNER JOIN nhanvien
                                                ON phongban.IDPB = nhanvien.IDPB where Hoten like '%{$keyword}%'
                                                ORDER BY IDNV ";
                                            }
                                            else 
                                                $qr_search="SELECT IDNV, Hoten, phongban.TenPB, Diachi 
										...
										$resultNV= $mysqli->query($qr_search);
